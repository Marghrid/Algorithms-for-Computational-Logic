...
def run(feature_count, node_count, samples):
	...
	global solver_time, num_solver_calls
...
if __name__ == "__main__":
	...
	while True:
		...
		solver_output = 'sat' if tree else 'unsat'
		if search.is_done(solver_output, tree, num_nodes):
			break
		else:
			num_nodes = search.get_next_n(num_nodes, solver_output)
